<?php if (!file_exists('config.php')) {echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"> <head> <title>Square CMS - Configuration</title> <meta http-equiv="Content-type" content="text/html; charset=UTF-8" /> <style type="text/css"> body { width: 100%; margin: 0 auto;}h1 {text-align: center; color: #444;}@media only screen and (max-device-width:480px) {body{text-align: center; padding-top: 50px;}.install {background: #ddd; padding: 5px; border: 1px solid #333;}.install:hover {background: #ccc;}a.install {color: #333; text-decoration: none;}</style> </head> <body> <h1>Unwrapping the <del>Box</del> Square...</h1> <p>Run the <a href="install/">install</a> to begin the installation process.</p> <br /> <a href="install/" title="Begin Install" class="install">Install Square CMS</a> </body> </html>'; exit();}
